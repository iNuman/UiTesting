...
class MovieDetailFragmentTest {
    ...
    fun test_isMovieDataVisible() {
        ...
        val description =
            "A tough aspiring chef is hired to bring home a mobster's son from the Amazon but becomes involved in the fight against" +
                    " an oppressive town operator and the search for a legendary treasure."
        val movie = Movie(
            id = movieId,
            title = title,
